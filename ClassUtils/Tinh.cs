...
namespace DATN_Linh.ClassUtils
{
	public class Tinh
	{
		...
		public Tinh(double Rb, double Rs, double Rsc, double nc, double mc, double nd, double md, double h, double a)
		{
			this.Rb = Rb;
			this.Rs = Rs;
			this.Rsc = Rsc;
			...
			this.Nd = nd*1000;
			this.Md = md*1000000;
			this.b = 300; // Chiều rộng mặc định của cột (mm)
		...
		public void Run()
		{ 	
			As1 = TinhAsCotChiuNenLechTam(Nc, Mc);
			As2 = TinhAsCotChiuNenLechTam(Nd, Md);
		}
